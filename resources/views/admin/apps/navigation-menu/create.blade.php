                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <input type="text" name="title" class="form-control form-control-solid @error('title') is-invalid @enderror" 
                               placeholder="Ex: Mécanique" value="{{ old('title') }}" required />
                        @error('title')
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-lg-9">
                        <select name="target" class="form-select form-select-solid @error('target') is-invalid @enderror">
                            <option value="_self" {{ old('target', '_self') == '_self' ? 'selected' : '' }}>Même fenêtre (_self)</option>
                            <option value="_blank" {{ old('target') == '_blank' ? 'selected' : '' }}>Nouvelle fenêtre (_blank)</option>
                        </select>
                        @error('target')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
