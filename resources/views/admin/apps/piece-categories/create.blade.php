<x-default-layout>
    @section('title')
        Ajouter une catégorie de pièce
    @endsection

    <form action="{{ route('apps.piece-categories.store') }}" method="POST" enctype="multipart/form-data" id="kt_piece_category_form">
        @csrf
                ...
                <div class="card card-flush mb-6 mb-xl-9">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="name" class="form-control mb-2 @error('name') is-invalid @enderror" placeholder="Ex: Mécanique, Freinage, etc." value="{{ old('name') }}" />
                            @error('name')
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="slug" class="form-control mb-2 @error('slug') is-invalid @enderror" placeholder="Généré automatiquement si vide" value="{{ old('slug') }}" />
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="4" placeholder="Description de la catégorie">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="number" name="order" class="form-control @error('order') is-invalid @enderror" placeholder="0" value="{{ old('order', 0) }}" min="0" />
