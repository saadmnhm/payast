...
use App\Http\Controllers\Api\NavigationMenuApiController;
...
// Navigation Menu API
Route::get('/navigation-menu', [NavigationMenuApiController::class, 'index']);
Route::get('/navigation-menu/{id}', [NavigationMenuApiController::class, 'show']);
